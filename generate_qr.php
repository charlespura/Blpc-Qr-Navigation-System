...
$qrUrl = "http://localhost/blpc-system/view.php?id=" . $id;
?>
...
<div class="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden fade-in-up">
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 text-center">
        ...
        <p class="text-indigo-200 text-sm">Scan to verify access</p>
    </div>
    ...
    <div class="p-6 flex flex-col items-center bg-gray-50">
        <p class="text-sm text-gray-500 mb-3 flex items-center">
            <i class="fas fa-camera mr-2"></i> Show this QR code to the rider
        </p>
        <div class="bg-white p-4 rounded-xl shadow-lg">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=<?php echo urlencode($qrUrl); ?>" 
        ...
        <div class="mt-5 w-full">
            <div class="bg-gray-100 rounded-lg p-3 flex items-center justify-between">
                <span class="text-xs text-gray-600 truncate flex-1"><?php echo $qrUrl; ?></span>
    ...
    <div class="bg-gray-100 p-3 text-center">
        <p class="text-xs text-gray-500">
            <i class="fas fa-clock mr-1"></i> Valid for one-time access • BLPC Security
        </p>
    </div>
</div>
